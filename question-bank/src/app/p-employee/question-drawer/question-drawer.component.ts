...
export class QuestionDrawerComponent implements OnInit, OnChanges,AfterViewChecked,AfterContentChecked {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.questionForm =  new FormGroup({
      questionName: new FormControl(this.questionEdit?.questionCode),
      questionCode: new FormControl(this.questionEdit?.questionName),
      questionGroup: new FormControl(this.questionEdit?.questionGroup),
      questionType: new FormControl(this.questionEdit?.questionType),
      questionCalculating: new FormControl(this.questionEdit?.questionCalculating),
